...
function HexToRgbgb(color, opacity = 1) {
    ...
    poster_commission(data, index) {
        ...
        return [{
            ...
            css: {
                ...
                borderWidth: '0',
                borderColor: HexToRgbgb(data.style.bgcolor, data.style.opacity),
                "mode": "scaleToFill",
                textAlign: 'center',
                lineHeight: px2rpx(data.style.height),
                "fontSize": px2rpx(data.style.fontsize),
                "color": data.style.color,
                "background": HexToRgbgb(data.style.bgcolor, data.style.opacity),
                "fontWeight": data.style.fontweight > 400 ? 'bold' : 'normal',
            }
        }, {
            type: 'text',
