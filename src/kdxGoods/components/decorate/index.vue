...
<template>
    <div class='decorate-components' v-if="mergeData">
        ...
        <DetailComment :component-data='mergeData' v-else-if='componentData.id=="detail_comment"' @custom-event='eventHandler'></DetailComment>
        <DetailInfo :component-data='mergeData' v-else-if='componentData.id=="detail_info"' @custom-event='eventHandler'></DetailInfo>
        <DetailNavbar :component-data='mergeData' v-else-if='componentData.id=="detail_navbar"' @custom-event='eventHandler'></DetailNavbar>
        <DetailPullup :component-data='mergeData' v-else-if='componentData.id=="detail_pullup"' @custom-event='eventHandler'></DetailPullup>
        <DetailSale :component-data='mergeData' v-else-if='componentData.id=="detail_sale"' @custom-event='eventHandler'></DetailSale>
        <DetailSpec :component-data='mergeData' v-else-if='componentData.id=="detail_spec"' @custom-event='eventHandler'></DetailSpec>
        <DetailSwipe :component-data='mergeData' v-else-if='componentData.id=="detail_swipe"' @custom-event='eventHandler'></DetailSwipe>
...
<script>
    ...
    // #ifndef H5
    import DetailSwipe from './templates/Detail_swipe'
    import DetailInfo from './templates/Detail_info'
    import DetailSale from './templates/Detail_sale'
    import DetailSpec from './templates/Detail_spec'
    import DetailComment from './templates/Detail_comment'
    import DetailPullup from './templates/Detail_pullup'
    import DetailNavbar from './templates/Detail_navbar'
    ...
    export default {
        ...
        // #ifdef H5
        components: {
            DetailSwipe:()=>import('./templates/Detail_swipe.vue'),
            DetailInfo:()=>import('./templates/Detail_info.vue'),
            DetailSale:()=>import('./templates/Detail_sale.vue'),
            DetailSpec:()=>import('./templates/Detail_spec.vue'),
            DetailComment:()=>import('./templates/Detail_comment.vue'),
            DetailPullup:()=>import('./templates/Detail_pullup.vue'),
            DetailNavbar:()=>import('./templates/Detail_navbar.vue'),
