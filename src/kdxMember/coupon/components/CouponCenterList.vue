        ...
        <ul>
            ...
            >
                ...
                >
                    <div class="box">
                        <div class="price">
                            <span style="font-size:24rpx;" v-if="item.coupon_sale_type === '1'">¥</span>
                            <span class="num">
                ...
                <div class="right">
                    ...
                    <div class="r-right">
                        <btn :classNames="[item.coupon_sale_type === '2' ? 'coupon-type2ac' : 'coupon-type1ac']" styles="width:152rpx;"  @btn-click="jumpCouponDetail(item)">立即领取</btn>
                    </div>
                </div>
            </li>
        </ul>
...
export default {
    ...
    onLoad() {},
    methods: {
        jumpCouponDetail(data) {
            const path = `/kdxMember/coupon/detail/index`
            this.$Router.auto({
                path,
                query: {
                    id: data.id,
