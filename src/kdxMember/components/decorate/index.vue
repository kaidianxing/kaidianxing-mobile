...
<template>
    <div class='decorate-components' v-if="mergeData">
        ...
        <BindmobileLogout :component-data='mergeData' v-else-if='componentData.id=="bindmobile" || componentData.id=="logout"' @custom-event='eventHandler'></BindmobileLogout>
        ...
        <Member :component-data='mergeData' v-else-if='componentData.id=="member"' @custom-event='eventHandler'></Member>
...
<script>
    ...
    // #ifndef H5
    import BindmobileLogout from './templates/Bindmobile.Logout'
    ...
    export default {
        ...
        // #ifdef H5
        components: {
            BindmobileLogout:()=>import('./templates/Bindmobile.Logout.vue'),
            ListmenuIcongroup:()=>import('@/components/decorate/templates/Listmenu.Icongroup'),
            Member:()=>import('./templates/Member.vue'),
